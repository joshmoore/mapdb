...
public final class SerializerCompressionDeflateWrapper<E> implements Serializer<E>, Serializable {
    ...
    public SerializerCompressionDeflateWrapper(Serializer<E> serializer) {
        this(serializer, Deflater.DEFAULT_STRATEGY, null);
    }

    public SerializerCompressionDeflateWrapper(Serializer<E> serializer, int compressLevel, byte[] dictionary) {
